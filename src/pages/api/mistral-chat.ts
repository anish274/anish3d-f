...
// Replace OpenAIEmbeddings with MistralAIEmbeddings
...
export default async function handler(
  ...
  try {
    ...
    // Call Mistral API with the retrieved context
    const response = await fetch('https://api.mistral.ai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are an AI assistant that answers questions about Anish Shah based ONLY on the information from his PDF document.
